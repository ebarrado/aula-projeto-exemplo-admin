<?php
    require "src/conect-db.php";
    require "src/Modelo/Produto.php";
    require "src/Controller/ProdutoController.php";

    $produtosRepositorio = new ProdutoController(
                            $pdo);
  ...
  <section class="container-table">
    <table>
      ...
      <tr>
        ...
        href="editar-produto.php?id=<?= 
        $produto->getId() ?>">Editar</a></td>
        <td>
          ...
          value="<?= $produto->getID()
          ?>">
            <input type="button" class="botao-excluir" 
            value="Excluir">
          </form>
        </td>
